z7_adjusted = function(data, width, threshold){
  require(zoo)
  ...
  #For tau3 and S1
  if(abs(tau3*prediction) < e){
    z7_tau3_1 = -(fEA + prediction) / S1
  }
  else 
    z7_tau3_1 = -(fEA + prediction) / (tau3*prediction)
}
